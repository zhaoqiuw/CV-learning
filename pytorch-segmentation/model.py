...
class PetModel(pl.LightningModule):
    ...
    def shared_epoch_end(self, outputs, stage):
        ...
        #print(outputs[0]['loss'],outputs[0]['loss'].size())
        ...
        per_image_f1_score = smp.metrics.f1_score(tp, fp, fn, tn, reduction="micro-imagewise")
        ...
        metrics = {
            ...
            f"{stage}_per_image_f1_score": per_image_f1_score,
